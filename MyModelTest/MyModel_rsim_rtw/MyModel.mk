...
## 
## Makefile     : MyModel.mk
## Generated on : Fri Jul 12 15:29:49 2024
...
START_DIR                 = C:/Users/zanga/Documents/MATLAB/MyModelTest
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
DEFINES_OPTS = -DNRT -DRSIM_WITH_SL_SOLVER -DRSIM_PARAMETER_LOADING -DTID01EQ=0
DEFINES_STANDARD = -DMODEL=MyModel -DNUMST=1 -DNCSTATES=2 -DHAVESTDIO
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/MyModel_rsim_rtw/MyModel.c $(START_DIR)/MyModel_rsim_rtw/MyModel_data.c $(START_DIR)/MyModel_rsim_rtw/rtGetInf.c $(START_DIR)/MyModel_rsim_rtw/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/rsim/rsim_main.c $(MATLAB_ROOT)/rtw/c/rsim/rsim_sup.c $(MATLAB_ROOT)/rtw/c/rsim/rsim_mat.c $(MATLAB_ROOT)/simulink/include/simulink_solver_api.c $(MATLAB_ROOT)/rtw/c/src/rapid/rsim_utils.c $(MATLAB_ROOT)/rtw/c/src/rapid/common_utils.c
...
OBJS = rt_logging.obj MyModel.obj MyModel_data.obj rtGetInf.obj rt_nonfinite.obj rsim_main.obj rsim_sup.obj rsim_mat.obj simulink_solver_api.obj rsim_utils.obj common_utils.obj
...
SYSTEM_LIBS =  -L"$(MATLAB_ROOT)/extern/lib/win64/mingw64" -llibmat -llibmx -llibut -llibmwsl_fileio -llibmwsl_simtarget_instrumentation -llibmwi18n -llibmwsigstream -llibmwsl_AsyncioQueue -lsf_runtime -llibmwsl_solver_rtw
...
%.obj : $(START_DIR)/MyModel_rsim_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/MyModel_rsim_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/MyModel_rsim_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/MyModel_rsim_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/MyModel_rsim_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MyModel.obj : $(START_DIR)/MyModel_rsim_rtw/MyModel.c
	$(CC) $(CFLAGS) -o "$@" "$<"


MyModel_data.obj : $(START_DIR)/MyModel_rsim_rtw/MyModel_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/MyModel_rsim_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/MyModel_rsim_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
